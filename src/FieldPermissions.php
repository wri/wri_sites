...
class FieldPermissions {
   ...
   *   labels.
   */
   public static function field_permissions_list($field_label = '') {
    return array(
      'create' => array(
   ...
   * @return
   *   An array of permission information, suitable for use in field_permissions_permissions_matrix.
   */
  ...
  public function permissions() {
   ...
   foreach( $instances as $key => $instance){
     ...
     $permission_list = $this->field_permissions_list($field_name);
